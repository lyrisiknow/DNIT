...
fig.legend(handles=lines_handles, labels=labels_list, loc='upper center', ncol=num_models, 
           bbox_to_anchor=(0.5, 0.95), frameon=True, fontsize=fn-2)

plt.subplots_adjust(top=0.80, bottom=0.15, left=0.08, right=0.98, hspace=0.2, wspace=0.25)
plt.savefig('auc_time_process_workplace.png', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.savefig('auc_time_process_workplace.pdf', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.show()
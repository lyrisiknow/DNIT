...
auc_pattern = re.compile(r'^mastodon_(.+)_p(\d+)auc$')
time_pattern = re.compile(r'^mastodon_(.+)_p(\d+)$')
...
plt.savefig('auc_time_process_mastodon.png', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.savefig('auc_time_process_mastodon.pdf', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.show()
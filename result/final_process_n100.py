...
auc_pattern = re.compile(r'^LFR_(.+)_n100p(\d+)auc$')
time_pattern = re.compile(r'^LFR_(.+)_n100p(\d+)$')
...
plt.savefig('auc_time_process_n100.png', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.savefig('auc_time_process_n100.pdf', dpi=300, bbox_inches='tight', pad_inches=0.05)
plt.show()
...
if __name__ == '__main__':
    ...
    for n_sim in [500,1000,1500,2000,2500]:
        ...
        result_record("klifts", calculate_binary_auc(IG, G), "mastodon", f"p{n_sim}auc", 'process.jsonl')
        result_record("klifts", end_time - start_time, "mastodon", f"p{n_sim}", 'time.jsonl')
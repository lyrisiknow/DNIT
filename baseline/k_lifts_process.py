...
if __name__ == '__main__':
    ...
    for n_sim in [50,100,150,200,250]:
        ...
        k_lifts_cost = end_time - start_time

        result_record("klifts", calculate_binary_auc(IG, G), "LFR", f"n{N}p{n_sim}auc", 'process.jsonl')
        result_record("klifts", k_lifts_cost, "LFR", f"n{N}p{n_sim}", 'time.jsonl')
...
if __name__ == '__main__':
    ...
    for n_sim in [500,1000,1500,2000,2500]:
        ...
        result_record("TWIND", calculate_binary_auc(IG, G), "LFR", f"n{N}p{n_sim}auc", 'process.jsonl')
        result_record("TWIND", twind_cost, "LFR", f"n{N}p{n_sim}", 'time.jsonl')
        ...
        result_record("TENDS", calculate_binary_auc(IG, G), "LFR", f"n{N}p{n_sim}auc", 'process.jsonl')
        result_record("TENDS", tends_cost, "LFR", f"n{N}p{n_sim}", 'time.jsonl')
        ...
        result_record("SIDN", calculate_binary_auc(IG, G), "LFR", f"n{N}p{n_sim}auc", 'process.jsonl')
        result_record("SIDN", sidn_cost, "LFR", f"n{N}p{n_sim}", 'time.jsonl')
        ...
        result_record("PIND", calculate_binary_auc(IG, G), "LFR", f"n{N}p{n_sim}auc", 'process.jsonl')
        result_record("PIND", pind_cost, "LFR", f"n{N}p{n_sim}", 'time.jsonl')

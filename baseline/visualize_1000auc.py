...
def plot_metrics(file_path):
    ...
    try:
            ...
            for line in f:
                ...
                for key, values in record.items():
                    ...
                    if last_part.startswith('n') and last_part.endswith('auc'):
                        ...
                        try:
                            n_val = int(n_str)
                            if n_val < 1000: continue # 过滤大于500的点
        ...
        plt.savefig('roc_auc_analysis1000.png', dpi=300, bbox_inches='tight')
        plt.show()
        ...
        plt.savefig('pr_auc_analysis1000.png', dpi=300, bbox_inches='tight')
        plt.show()

...
if __name__ == '__main__':
    ...
    result_record("TWIND", calculate_binary_auc(IG, G), "workplace", f"n{N}auc", 'resultn.jsonl')
    result_record("TWIND", twind_cost, "workplace", f"n{N}", 'timen.jsonl')
    result_record("TWIND", calculate_F1(IG, G), "workplace", f"n{N}f1", 'resultn.jsonl')
    ...
    result_record("TENDS", calculate_binary_auc(IG, G), "workplace", f"n{N}auc", 'resultn.jsonl')
    result_record("TENDS", tends_cost, "workplace", f"n{N}", 'timen.jsonl')
    result_record("TENDS", calculate_F1(IG, G), "workplace", f"n{N}f1", 'resultn.jsonl')
    ...
    result_record("SIDN", calculate_binary_auc(IG, G), "workplace", f"n{N}auc", 'resultn.jsonl')
    result_record("SIDN", sidn_cost, "workplace", f"n{N}", 'timen.jsonl')

    result_record("SIDN", calculate_F1(IG, G), "workplace", f"n{N}f1", 'resultn.jsonl')
    ...
    result_record("PIND", calculate_binary_auc(IG, G), "workplace", f"n{N}auc", 'resultn.jsonl')
    result_record("PIND", pind_cost, "workplace", f"n{N}", 'timen.jsonl')
    result_record("PIND", calculate_F1(IG, G), "workplace", f"n{N}f1", 'resultn.jsonl')
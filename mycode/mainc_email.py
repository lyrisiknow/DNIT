...
import numpy as np
from modelc import run_torch_version
import json
...
if __name__ == '__main__':
    for n_sim in [1000]:
        ...
        iterations = 10000
        lr = 0.01
        auc, cost_time,f1 = run_torch_version(G, N, S, C, A, gamma, prune_network, iterations = iterations, lr=lr)
        result_record("mymodel", auc, "email", f'auc-', 'process.jsonl')
        result_record("mymodel", cost_time, "email", f'-', 'time.jsonl')